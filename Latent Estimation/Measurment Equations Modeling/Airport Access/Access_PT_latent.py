...
PTGUY_coef_HHM1 = Beta('PTGUY_coef_HHM1', 0, None, None, 1)
PTGUY_coef_HHM2 = Beta('PTGUY_coef_HHM2', 0, None, None, 1)
PTGUY_coef_IGN = Beta('PTGUY_coef_IGN', 0, None, None, 1)
...
PTGUY_coef_IEDU1 = Beta('PTGUY_coef_IEDU1', 0, None, None, 1)
...
PTGUY_coef_IWORK2 = Beta('PTGUY_coef_Occupation Employee Private', 0, None, None, 1)
...
PTGUY_coef_IWORK5 = Beta('PTGUY_coef_Occupation Retired', 0, None, None, 0)
...
PTGUY_coef_IRTEH1 = Beta('PTGUY_coef_IRTEH1', 0, None, None, 0)
PTGUY_coef_IWTEH1 = Beta('PTGUY_coef_IWTEH1', 0, None, None, 1)
PTGUY_coef_HINC1 = Beta('PTGUY_coef_Household Income < 3.5', 0, None, None, 1)
PTGUY_coef_HINC2 = Beta('PTGUY_coef_Household Income 3.5 - 6', 0, None, None, 0)
PTGUY_coef_HINC3 = Beta('PTGUY_coef_Household Income 6 - 9', 0, None, None, 0)
...
PTGUY_coef_HINC6 = Beta('PTGUY_coef_Household Income 20 - 30', 0, None, None, 0)
...
PTGUY_coef_IPHU3 = Beta('PTGUY_coef_IPHU3', 0, None, None, 0)
PTGUY_coef_RH1 = Beta('PTGUY_coef_Ride Hailing Use > Once Week-RH', 0, None, None, 1)
PTGUY_coef_RH2 = Beta('PTGUY_coef_Ride Hailing Use = Once Week-RH', 0, None, None, 0)
PTGUY_coef_RH3 = Beta('PTGUY_coef_Ride Hailing Use = Once Month-RH', 0, None, None, 0)
PTGUY_coef_RH4 = Beta('PTGUY_coef_Ride Hailing Use < Once Month-RH', 0, None, None, 0)
PTGUY_coef_RH5 = Beta('PTGUY_coef_Ride Hailing Use = Never', 0, None, None, 0)
PTGUY_coef_RHUSE111 = Beta('PTGUY_coef_RH FOR 01AIRPORT', 0, None, None, 1)
PTGUY_coef_RHUSE211 = Beta('PTGUY_coef_RH FOR 02WORK ALWAYS', 0, None, None, 1)
PTGUY_coef_RHUSE311 = Beta('PTGUY_coef_RH FOR 03WORK OCCASIONLY', 0, None, None, 1)
PTGUY_coef_RHUSE411 = Beta('PTGUY_coef_RH FOR 04NIGHT OUT', 0, None, None, 1)
PTGUY_coef_RHUSE511 = Beta('PTGUY_coef_RH FOR 05REC', 0, None, None, 1)
PTGUY_coef_RHUSE611 = Beta('PTGUY_coef_RH FOR 06OTHERS', 0, None, None, 1)
PTGUY_coef_CAR_OW0 = Beta('PTGUY_coef_CAR_OW0', 0, None, None, 1)
PTGUY_coef_CAR_OW1 = Beta('PTGUY_coef_CAR_OW1', 0, None, None, 1)
PTGUY_coef_CAR_OW2 = Beta('PTGUY_coef_CAR_OW2', 0, None, None, 0)
'''
...
PTGUY = PTGUY_coef_intercept + \
          ...
          PTGUY_coef_RH3 * RH3 + \
          PTGUY_coef_RH4 * RH4 + \
          PTGUY_coef_RHUSE111 * RHUSE111 + \
          PTGUY_coef_RHUSE211 * RHUSE211 + \
          PTGUY_coef_RHUSE311 * RHUSE311 + \
          PTGUY_coef_RHUSE411 * RHUSE411 + \
          PTGUY_coef_RHUSE511 * RHUSE511 + \
          PTGUY_coef_RHUSE611 * RHUSE611 + \
...
the_biogeme.modelName = 'Access_PTGuy_latent'
