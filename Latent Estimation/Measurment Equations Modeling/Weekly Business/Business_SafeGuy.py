...
SAFEGUY_coef_HHM1 = Beta('SAFEGUY_coef_Household Member123', 0, None, None, 1)
SAFEGUY_coef_HHM2 = Beta('SAFEGUY_coef_Household Member45', 0, None, None, 1)
SAFEGUY_coef_IGN = Beta('SAFEGUY_coef_Gender', 0, None, None, 0)
SAFEGUY_coef_IAGE1 = Beta('SAFEGUY_coef_Age < 18', 0, None, None, 1)
SAFEGUY_coef_IAGE2 = Beta('SAFEGUY_coef_Age 18 - 24', 0, None, None, 0)
SAFEGUY_coef_IAGE3 = Beta('SAFEGUY_coef_Age 25 - 34', 0, None, None, 1)
SAFEGUY_coef_IAGE4 = Beta('SAFEGUY_coef_Age 35 - 44', 0, None, None, 0)
SAFEGUY_coef_IAGE5 = Beta('SAFEGUY_coef_Age 45 - 54', 0, None, None, 0)
SAFEGUY_coef_IAGE6 = Beta('SAFEGUY_coef_Age 55 - 64', 0, None, None, 1)
SAFEGUY_coef_IEDU1 = Beta('SAFEGUY_coef_IEDU1', 0, None, None, 1)
SAFEGUY_coef_IEDU2 = Beta('SAFEGUY_coef_IEDU2', 0, None, None, 0)
SAFEGUY_coef_IEDU3 = Beta('SAFEGUY_coef_IEDU3', 0, None, None, 0)
SAFEGUY_coef_IEDU4 = Beta('SAFEGUY_coef_IEDU4', 0, None, None, 1)
...
SAFEGUY_coef_IWORK3 = Beta('SAFEGUY_coef_Occupation Employee Public', 0, None, None, 1)
...
SAFEGUY_coef_IWORK6 = Beta('SAFEGUY_coef_Occupation Unofficial', 0, None, None, 1)
SAFEGUY_coef_IOPW1 = Beta('SAFEGUY_coef_IOPW1', 0, None, None, 1)
SAFEGUY_coef_IOPW2 = Beta('SAFEGUY_coef_IOPW2', 0, None, None, 1)
SAFEGUY_coef_IRTEH1 = Beta('SAFEGUY_coef_Res TEH', 0, None, None, 0)
SAFEGUY_coef_IWTEH1 = Beta('SAFEGUY_coef_Work TEH', 0, None, None, 1)
SAFEGUY_coef_HINC1 = Beta('SAFEGUY_coef_Household Income < 3.5', 0, None, None, 1)
SAFEGUY_coef_HINC2 = Beta('SAFEGUY_coef_Household Income 3.5 - 6', 0, None, None, 1)
...
SAFEGUY_coef_HINC5 = Beta('SAFEGUY_coef_Household Income 14 - 20', 0, None, None,1)
...
SAFEGUY_coef_IPHU3 = Beta('SAFEGUY_coef_IPHU3', 0, None, None, 1)
SAFEGUY_coef_RH1 = Beta('SAFEGUY_coef_Ride Hailing Use > Once Week-RH', 0, None, None, 0)
SAFEGUY_coef_RH2 = Beta('SAFEGUY_coef_Ride Hailing Use = Once Week-RH', 0, None, None, 1)
SAFEGUY_coef_RH3 = Beta('SAFEGUY_coef_Ride Hailing Use = Once Month-RH', 0, None, None, 1)
...
SAFEGUY_coef_RHUSE111 = Beta('SAFEGUY_coef_RH FOR 01AIRPORT', 0, None, None, 0)
SAFEGUY_coef_RHUSE211 = Beta('SAFEGUY_coef_RH FOR 02WORK ALWAYS', 0, None, None, 0)
SAFEGUY_coef_RHUSE311 = Beta('SAFEGUY_coef_RH FOR 03WORK OCCASIONLY', 0, None, None, 0)
SAFEGUY_coef_RHUSE411 = Beta('SAFEGUY_coef_RH FOR 04NIGHT OUT', 0, None, None, 0)
SAFEGUY_coef_RHUSE511 = Beta('SAFEGUY_coef_RH FOR 05REC', 0, None, None, 0)
SAFEGUY_coef_RHUSE611 = Beta('SAFEGUY_coef_RH FOR 06OTHERS', 0, None, None, 0)
SAFEGUY_coef_CAR_OW0 = Beta('SAFEGUY_coef_CAR_OW0', 0, None, None, 1)
SAFEGUY_coef_CAR_OW1 = Beta('SAFEGUY_coef_CAR_OW1', 0, None, None, 1)
SAFEGUY_coef_CAR_OW2 = Beta('SAFEGUY_coef_CAR_OW2', 0, None, None, 1)
...
the_biogeme.modelName = 'Business_SAFEGUY'
