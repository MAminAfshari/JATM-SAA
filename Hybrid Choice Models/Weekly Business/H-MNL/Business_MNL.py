...
ASC_RH            = Beta('02 Constant Ride-Hailing',       0, None, None, 0)
...
logprob = models.logit(V, av, WorkTrip_CHOICE)

loglike = log(MonteCarlo(logprob))

#loglike = log(Integrate(logprob * density),'omega')

# Create the Biogeme object
biogeme = bio.BIOGEME(database,loglike)
biogeme.modelName = 'MNL_B'
