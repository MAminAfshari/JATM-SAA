...
ASC_AU            = Beta('01 Constant Auto',               0, None, None, 1)
ASC_RH            = Beta('02 Constant Ride-Hailing',       0, None, None, 1)
ASC_AT            = Beta('03 Constant Air Flying Taxi',    0, None, None, 1)#
ASC_PT            = Beta('04 Constant Public Transport',   0, None, None, 1)
B_TT              = Beta('*Travel Time',                  0, None, None, 0)
B_COST            = Beta('*Cost',                          0, None, None, 0)
B_AU_TT           = Beta('*Auto Travel Time',              0, None, None, 0)
B_AU_CO           = Beta('*Auto Cost',                     0, None, None, 1)#
B_AU_WT           = Beta('*Auto Wait Time',                0, None, None, 0)
B_PT_TT           = Beta('*Public Transport Travel Time',  0, None, None, 0)
B_PT_CO           = Beta('*Public Transport Cost',         0, None, None, 0)#
...
B_RH_TT           = Beta('*Ride-Hailing Travel Time',      0, None, None, 1)#
B_RH_CO           = Beta('*Ride-Hailing Cost',             0, None, None, 1)
...
B_RH1_AU             = Beta('Ride Hailing Use more Once Week AU', 0, None, None, 0)
B_RH2_AU             = Beta('Ride Hailing Use eq Once Week AU', 0, None, None, 0)
B_RH3_AU             = Beta('Ride Hailing Use eq Once Month AU',0, None, None, 0)
B_RH4_AU             = Beta('Ride Hailing Use less Once Month AU',0, None, None, 0)
...
B_TMCA1_AU       = Beta('Taxi More Comfortable Than Auto/AGREE-AU' ,0, None, None, 0)
B_TMCA2_AU       = Beta('Taxi More Comfortable Than Auto/DAGREE-AU',0, None, None, 1)
...
B_TAUTOD2_AU     = Beta('Trust Automatic Drive/DAGREE-AU'          ,0, None, None, 1)
...
B_PRETAXI1_AU    = Beta('Prefer Taxi/AGREE-AU'                     ,0, None, None, 0)
B_PRETAXI2_AU    = Beta('Prefer Taxi/DAGREE-AU'                    ,0, None, None, 0)
B_USEDCRU1_AU    = Beta('Used Cruise/AGREE-AU'                     ,0, None, None, 1)
...
B_USETIME1_AU    = Beta('Using Time in Auto/AGREE-AU'              ,0, None, None, 1)
...
B_MOBIMPORT1_AU  = Beta('Mobile Is Important/AGREE-AU'             ,0, None, None, 1)
B_MOBIMPORT2_AU  = Beta('Mobile Is Important/DAGREE-AU'            ,0, None, None, 0)
...
B_ECOSATIS1_AU   = Beta('Economical Satisfied/AGREE-AU'            ,0, None, None, 1)
...
B_HINC6_RH           = Beta('Household Income 20 - 30 Mt-RH',    0, None, None, 0)
...
B_TMCA1_RH       = Beta('Taxi More Comfortable Than Auto/AGREE-RH' ,0, None, None, 1)
B_TMCA2_RH       = Beta('Taxi More Comfortable Than Auto/DAGREE-RH',0, None, None, 0)
B_NCAW1_RH       = Beta('Need Car At Work/AGREE-RH'                ,0, None, None, 1)
B_NCAW2_RH       = Beta('Need Car At Work/DAGREE-RH'               ,0, None, None, 0)
B_PNTD1_RH       = Beta('Prefer Not To Drive/AGREE-RH'             ,0, None, None, 0)
...
B_PREPT1_RH      = Beta('Prefer To Use PT/AGREE-RH'                ,0, None, None, 1)
...
B_USEDCRU1_RH    = Beta('Used Cruise/AGREE-RH'                     ,0, None, None, 0)
...
B_PRIVACY1_RH    = Beta('Worry About Privacy/AGREE-RH'             ,0, None, None, 1)
B_PRIVACY2_RH    = Beta('Worry About Privacy/DAGREE-RH'            ,0, None, None, 1)
...
B_IAGE2_AT           = Beta('Age 18 - 24-AT',                    0, None, None, 0)
...
B_IWORK1_AT          = Beta('Occupation Owner-AT',               0, None, None, 1)
...
B_HINC6_AT           = Beta('Household Income 20 - 30 Mt-AT',    0, None, None, 1)
...
B_RH1_AT             = Beta('Ride Hailing Use > Once / Week-AT', 0, None, None, 0)
B_RH2_AT             = Beta('Ride Hailing Use = Once / Week-AT', 0, None, None, 0)
B_RH3_AT             = Beta('Ride Hailing Use = Once / Month-AT',0, None, None, 0)
B_RH4_AT             = Beta('Ride Hailing Use < Once / Month-AT',0, None, None, 0)
...
B_TMCA1_AT       = Beta('Taxi More Comfortable Than Auto/AGREE-AT' ,0, None, None, 0)
B_TMCA2_AT       = Beta('Taxi More Comfortable Than Auto/DAGREE-AT',0, None, None, 1)
...
B_TAUTOD2_AT     = Beta('Trust Automatic Drive/DAGREE-AT'          ,0, None, None, 1)
...
B_TTOPERA1_AT    = Beta('Talking To Operator/AGREE-AT'             ,0, None, None, 1)
...
B_TECHMA1_AT     = Beta('Technology Matter/AGREE-AT'               ,0, None, None, 0)
...
B_PREPT1_AT      = Beta('Prefer To Use PT/AGREE-AT'                ,0, None, None, 0)
...
B_USEDCRU1_AT    = Beta('Used Cruise/AGREE-AT'                     ,0, None, None, 1)
...
B_USETIME1_AT    = Beta('Using Time in Auto/AGREE-AT'              ,0, None, None, 0)
...
B_MOBIMPORT1_AT  = Beta('Mobile Is Important/AGREE-AT'             ,0, None, None, 1)
...
B_RECIMPORT2_AT  = Beta('Recreation Rather Work/DAGREE-AT'         ,0, None, None, 1)
...
B_ECOSATIS1_AT   = Beta('Economical Satisfied/AGREE-AT'            ,0, None, None, 1)
...
B_HINC2_PT           = Beta('Household Income 3.5 - 6 Mt-PT',    0, None, None, 0)
...
B_RH1_PT             = Beta('Ride Hailing Use more Once Week PT', 0, None, None, 0)
B_RH2_PT             = Beta('Ride Hailing Use eq Once Week PT', 0, None, None, 0)
B_RH3_PT             = Beta('Ride Hailing Use eq Once Month PT',0, None, None, 0)
B_RH4_PT             = Beta('Ride Hailing Use less Once Month PT',0, None, None, 0)
...
B_NCAW1_PT       = Beta('Need Car At Work/AGREE-PT'                ,0, None, None, 1)
B_NCAW2_PT       = Beta('Need Car At Work/DAGREE-PT'               ,0, None, None, 0)
B_PNTD1_PT       = Beta('Prefer Not To Drive/AGREE-PT'             ,0, None, None, 0)
B_PNTD2_PT       = Beta('Prefer Not To Drive/DAGREE-PT'            ,0, None, None, 1)
...
B_TTOPERA2_PT    = Beta('Talking To Operator/DAGREE-PT'            ,0, None, None, 1)
...
B_MOBIMPORT1_PT  = Beta('Mobile Is Important/AGREE-PT'             ,0, None, None, 0)
...
MODELNAMESAFE = 'Business_SAFEGUY'
try:
...
MODELNAMETECH = 'Business_TECHGUY'
try:
...
PTGUY_coef_IGN = struct_betas_pt['PTGUY_coef_Gender'] 
PTGUY_coef_IAGE5 = struct_betas_pt['PTGUY_coef_Age 45 - 54']
PTGUY_coef_IEDU1 = struct_betas_pt['PTGUY_coef_IEDU1'] 
PTGUY_coef_IWORK2 = struct_betas_pt['PTGUY_coef_Occupation Employee Private'] 
PTGUY_coef_IWORK4 = struct_betas_pt['PTGUY_coef_Occupation Student'] 
PTGUY_coef_IRTEH1 = struct_betas_pt['PTGUY_coef_Res TEH'] 
PTGUY_coef_IWTEH1 = struct_betas_pt['PTGUY_coef_Work TEH'] 
PTGUY_coef_RH1 = struct_betas_pt['PTGUY_coef_Ride Hailing Use > Once Week-RH'] 
PTGUY_coef_RH4 = struct_betas_pt['PTGUY_coef_Ride Hailing Use < Once Month-RH'] 
PTGUY_coef_CAR_OW0 = struct_betas_pt['PTGUY_coef_CAR_OW0'] 
PTGUY_coef_CAR_OW1 = struct_betas_pt['PTGUY_coef_CAR_OW1'] 

SAFEGUY_coef_intercept  = struct_betas_safe['SAFEGUY_coef_intercept'] 
SAFEGUY_coef_IGN = struct_betas_safe['SAFEGUY_coef_Gender']  
SAFEGUY_coef_IAGE2 = struct_betas_safe['SAFEGUY_coef_Age 18 - 24'] 
SAFEGUY_coef_IAGE4 = struct_betas_safe['SAFEGUY_coef_Age 35 - 44'] 
SAFEGUY_coef_IAGE5 = struct_betas_safe['SAFEGUY_coef_Age 45 - 54'] 
SAFEGUY_coef_IRTEH1 = struct_betas_safe['SAFEGUY_coef_Res TEH'] 
SAFEGUY_coef_IEDU2 = struct_betas_safe['SAFEGUY_coef_IEDU2'] 
SAFEGUY_coef_IEDU3 = struct_betas_safe['SAFEGUY_coef_IEDU3']
SAFEGUY_coef_IPHU1 = struct_betas_safe['SAFEGUY_coef_IPHU1'] 
SAFEGUY_coef_RH1 = struct_betas_safe['SAFEGUY_coef_Ride Hailing Use > Once Week-RH'] 


TECHGUY_coef_intercept = struct_betas_tech['TECHGUY_coef_intercept'] 
TECHGUY_coef_IAGE3 = struct_betas_tech['TECHGUY_coef_Age 25 - 34'] 
TECHGUY_coef_IAGE5 = struct_betas_tech['TECHGUY_coef_Age 45 - 54'] 
TECHGUY_coef_IWORK2 = struct_betas_tech['TECHGUY_coef_Occupation Employee Private'] 
TECHGUY_coef_IWORK4 = struct_betas_tech['TECHGUY_coef_Occupation Student'] 
TECHGUY_coef_IWORK5 = struct_betas_tech['TECHGUY_coef_Occupation Retired']
TECHGUY_coef_IRTEH1 = struct_betas_tech['TECHGUY_coef_Res TEH'] 
TECHGUY_coef_IWTEH1 = struct_betas_tech['TECHGUY_coef_Work TEH']  
TECHGUY_coef_IPHU1 = struct_betas_tech['TECHGUY_coef_IPHU1'] 
TECHGUY_coef_CAR_OW1 = struct_betas_tech['TECHGUY_coef_CAR_OW1'] 
TECHGUY_coef_CAR_OW2 = struct_betas_tech['TECHGUY_coef_CAR_OW2'] 

sigma_s_pt = Beta('sigma_s_pt', 1, None, None, 0)
...
TECHGUY = TECHGUY_coef_intercept + \
          ...
          TECHGUY_coef_CAR_OW2 * CAR_OW2 + error_component_tech


B_PTGUY_AU = Beta('B_PTGUY_AU', 0, None, None, 0)
B_PTGUY_RH = Beta('B_PTGUY_RH', 0, None, None, 0)
B_PTGUY_AT = Beta('B_PTGUY_AT', 0, None, None, 0)
B_PTGUY_PT = Beta('B_PTGUY_PT', 0, None, None, 0)

B_SAFEGUY_AU = Beta('B_SAFEGUY_AU', 0, None, None, 0)
B_SAFEGUY_RH = Beta('B_SAFEGUY_RH', 0, None, None, 0)
B_SAFEGUY_AT = Beta('B_SAFEGUY_AT', 0, None, None, 0)
B_SAFEGUY_PT = Beta('B_SAFEGUY_PT', 0, None, None, 0)

B_TECHGUY_AU = Beta('B_TECHGUY_AU', 0, None, None, 0)
B_TECHGUY_RH = Beta('B_TECHGUY_RH', 0, None, None, 0)
B_TECHGUY_AT = Beta('B_TECHGUY_AT', 0, None, None, 0)
B_TECHGUY_PT = Beta('B_TECHGUY_PT', 0, None, None, 0)

# Definition of the utility functions 

V1 =ASC_AU +\
    B_AU_TT      * (W_CAR_TT + W_CAR_WT)+\
    B_AU_CO      * W_CAR_CO +\
    B_SM_PT_AU   * SM_PT  +\
    B_IWORK4_AU  * IWORK4 +\
    B_IWORK5_AU  * IWORK5 +\
...
logprob = models.nested(V, av, nests, WorkTrip_CHOICE)
loglike = log(MonteCarlo(logprob))
biogeme = bio.BIOGEME(database,loglike)
biogeme.modelName = 'NL_B_Latent'
